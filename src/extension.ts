...
export function activate(context: vscode.ExtensionContext) {
  ...
  const identifierProvider = vscode.languages.registerCompletionItemProvider("plaintext", {
    provideCompletionItems(
      ...
      return;
      [variableCompletion, classCompletion];
    },
  });
